...
const AdminCommandeDetail = () => {
  ...
  if (loading) return <AdminLayout><p style={{ padding: "2rem" }}>Chargement...</p></AdminLayout>;
  if (!order) return <AdminLayout><p style={{ padding: "2rem" }}>Commande introuvable</p></AdminLayout>;
